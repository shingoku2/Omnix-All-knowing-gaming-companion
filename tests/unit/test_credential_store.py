...
class TestCredentialStoreInitialization:
    ...
    def test_store_initialization(self, temp_config_dir):
        """Test creating credential store"""
        store = CredentialStore(base_dir=temp_config_dir, allow_password_prompt=False)
        assert store is not None

    def test_store_creates_encryption_key(self, temp_config_dir):
...
class TestCredentialStorage:
    ...
    def test_set_and_get_credential(self, temp_config_dir):
    ...
    def test_get_nonexistent_credential(self, temp_config_dir):
    ...
    def test_delete_credential(self, temp_config_dir):
    ...
    def test_multiple_credentials(self, temp_config_dir):
...
class TestCredentialPersistence:
    ...
    def test_credentials_persist_across_instances(self, temp_config_dir):
        """Test that credentials persist across store instances"""
        # First instance
        store1 = CredentialStore(base_dir=temp_config_dir, allow_password_prompt=False)
        store1.save_credentials({"persistent_key": "persistent_value"})

        # Second instance
        store2 = CredentialStore(base_dir=temp_config_dir, allow_password_prompt=False)
...
class TestCredentialEncryption:
    ...
    def test_credentials_stored_encrypted(self, temp_config_dir):
...
class TestErrorHandling:
    ...
    def test_handles_invalid_service_name(self, temp_config_dir):
    ...
    def test_handles_invalid_key_name(self, temp_config_dir):
...
class TestAPIKeyStorage:
    ...
    def test_store_openai_key(self, temp_config_dir):
    ...
    def test_store_anthropic_key(self, temp_config_dir):
    ...
    def test_store_gemini_key(self, temp_config_dir):
    ...
    def test_update_existing_key(self, temp_config_dir):
